...
function Header({account, getUserAccount}) {
  ...
  return (
    <div className="header">
      <div className="header-container">
        <div className="header-container-top">
          <div className="header-container-top-left">
            <img src={iconhamburger} alt="iconhamburger" className="icon-humburger pointer" onClick={() => showSidebarVertical()} />
            <div className="logo-page">
              <img src={logopage} alt="logopage" className=" pointer"  onClick={() =>history.push("/")}/>
            </div>
          </div>
          <div className="header-container-top-right">
            <div className="header-container-top-right-icon pointer"><img src={iconthongbao} alt="inconthongbao" /> <span>Thông báo</span></div>
            <div className="header-container-top-right-icon pointer"> <FcLike className="icon-love" /> <span>Yêu thích</span></div>
            {
                ...
                : (
                  <div className="header-container-top-right-icon pointer">
                    ...
                    <span>{JSON.parse(localStorage.getItem("user")).firstName} {JSON.parse(localStorage.getItem("user")).lastName}</span>
                  </div>
                )
            }
          </div>
      ...
      <div className="tongle-sidebar-vertical">
        <div className={` ${showVerticalSidebar === true ? "show-sidebar-vertical" : "hide-sidebar-vertical"}`}>
